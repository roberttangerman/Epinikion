			...
			$general_site_loader_options = array(
				...
				'fields'     => array(
					array(
						...
						'description' => __( 'Loading overlay is shown until whole page is loaded.', 'porto' ),
						'default'     => false,
						'on'          => __( 'Show', 'porto' ),
						'off'         => __( 'Hide', 'porto' ),
						'customizer'  => false,
			...
			$this->sections[] = array(
				...
				'fields'     => array(
					...
					array(
						...
						'desc'    => __( 'If enabled, portfolio content should be displayed at the top of portfolios or on modal when you click portfolio item in the list.', 'porto' ),
						'default' => false,
						'on'      => __( 'Yes', 'porto' ),
						'off'     => __( 'No', 'porto' ),
					),
					...
					array(
						...
						'default'  => '',
						'required' => array(
							array( 'portfolio-infinite', 'not', '' ),
							array( 'portfolio-cat-sort-pos', 'not', 'hide' ),
						),
					),
					array(
				...
				array(
					...
					'fields'     => array(
						...
						array(
							...
							'type'    => 'switch',
							'title'   => __( 'Enable Ajax Load', 'porto' ),
							'desc'    => __( 'If enabled, member content should be displayed at the top of members or on modal when you click member item in the list.', 'porto' ),
							'default' => false,
							'on'      => __( 'Yes', 'porto' ),
							'off'     => __( 'No', 'porto' ),
						),
						...
						array(
							...
							'default'  => '',
							'required' => array(
								array( 'member-infinite', 'not', '' ),
								array( 'member-cat-sort-pos', 'not', 'hide' ),
							),
						),
						array(
							'id'      => 'member-columns',
				...
				array(
					...
					'fields'     => array(
						...
						array(
							...
							'default'  => '',
							'required' => array(
								array( 'faq-infinite', 'not', '' ),
								array( 'faq-cat-sort-pos', 'not', 'hide' ),
							),
						),
					),
				),
			...
			$this->sections[] = array(
				...
				'fields'     => array(
					...
					array(
						...
						'subtitle'  => __( 'Products display mode in shop pages', 'porto' ),
					...
					array(
						...
						'subtitle'  => __( 'The position of content section which contains title, descrition and product count in a product category', 'porto' ),
						'default'   => '',
						'options'   => array(
