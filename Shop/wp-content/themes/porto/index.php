...
$wrap_cls   = '';
$wrap_attrs = '';
if ( $porto_settings['blog-infinite'] ) {
...
if ( 'timeline' == $post_layout ) {
	...
	$post_loop_start .= '<div class="blog-posts posts-' . esc_attr( $post_layout ) . ( ! $porto_settings['post-style'] ? '' : 'blog-posts-' . esc_attr( $porto_settings['post-style'], $wrap_cls ) ) . '"' . $wrap_attrs . '>';
